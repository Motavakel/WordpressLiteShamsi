/*
* JalaliDatePicker v1.0.0
* Copyright (c) 2023 Majid Houshyar 
    ...
    ! function() {
        ...
        var b = Number.isNaN || window.isNaN,
            ...
            N = function(t, n, e) {
                return i = function(t, n, e, i, a, o) {
                    for (var r = H(a, o) - H(n, e), s = t < i ? i : t, h = t < i ? t : i; h < s; h++) S(h) ? r += t < i ? 366 : -366 : r += t < i ? 365 : -365;
                    return r
                    ...
                    if (n = s[u], !x(n) && null !== n)
                        for (var y = 0; y < window.Object.keys(n).length; y++) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(n, l)) {
                                ...
                                a = Array.isArray(i), p && i && (O(i) || a) ? (e = c[l], o = a && !Array.isArray(e) ? [] : a || O(e) ? e : {}, c[l] = t(p, o, i)) : x(i) || (c[l] = i)
                            }
                        }
                return c
            },
            ...
            X = function() {
                for (var t = Y(r, K.dpContainer), n = 0; n < 7; n++) Y(h + R(n), t, null, null, K.options.days[n]);
                for (var e, i, a = (e = K.initDate.year, i = K.initDate.month, [0, 31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, S(e) ? 30 : 29][i]), o = N(K.initDate.year, K.initDate.month, 1), c = 7 * Math.ceil((o + a) / 7) - 1, u = 1, d = function(n) {
                        var e, i, o, r, h = N(K.initDate.year, K.initDate.month, u),
                            c = (e = K.initDate, i = u, o = K.options.minDate, r = K.options.maxDate, !(!O(o) || !O(r)) || (o.year === r.year && o.month === r.month ? i >= o.day && i <= r.day : e.year === o.year && e.month === o.month ? i >= o.day : e.year !== r.year || e.month !== r.month || i <= r.day));
        ...
        var Q = {
            ...
            U = {
                ...
                get initDate() {
                    return this._initDate = this._initDate || E(this.valueDate), O(this._initDate) && (this._initDate = this.options.initDate || E(this.today)), M(this._initDate) && B(this._initDate, this.options.separatorChar) && (this._initDate = T(this._initDate, this.options.separatorChar)), z(this._initDate.year, this._initDate.month, this._initDate.day, this._initDate, this.options.minDate, this.options.maxDate)
                },
                _draw: function() {
                    L((K = this).dpContainer, ""), q(), F(), X(), G()
                },
                show: function(t) {
                    this._initDate = null, this._valueDate = null, this.input = t, this._draw(), this.dpContainer.style.visibility = w, this.dpContainer.style.display = "block", this.dpContainer.style.zIndex = this.options.zIndex, this.setPosition(),
                        function(t) {
                ...
                setPosition: function() {
                    if (this.dpContainer.style.visibility === w) {
                        var t = this.input.getBoundingClientRect(),
                            ...
                            e = t.top,
                            i = t.height;
                        n + this.dpContainer.offsetWidth >= window.document.body.offsetWidth && (n -= n + this.dpContainer.offsetWidth - (window.document.body.offsetWidth + 10)), e + this.dpContainer.offsetHeight >= window.innerHeight && (e -= this.dpContainer.offsetHeight + i), this.dpContainer.style.position = "fixed", this.dpContainer.style.left = n + "px", this.dpContainer.style.top = e + this.input.offsetHeight + "px"
                    }
                },
                setValue: function(t, n, e) {
                    var i, a, o, r, s, h;
                    this._valueDate.year = t, this._valueDate.month = n, this._valueDate.day = e, this.hide(), isNaN(t + n + e) ? this.input.value = "" : this.input.value = (i = t, a = n, o = e, r = this.options.separatorChar, i + r + j(a) + r + j(o)), s = this.input, h = f, s && (s.dispatchEvent(W(h)), h === f && (s.dispatchEvent(W("change")), s.dispatchEvent(W("input"))))
                },
